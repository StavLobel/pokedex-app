...
class TestFileValidation:
    ...
    @pytest.mark.asyncio
    async def test_validate_valid_jpeg_file(
        self, image_validation_service, valid_jpeg_file
    ):
    ...
    @pytest.mark.asyncio
    async def test_validate_valid_png_file(
        self, image_validation_service, valid_png_file
    ):
    ...
    @pytest.mark.asyncio
    async def test_validate_invalid_file_type(
        self, image_validation_service, invalid_type_file
    ):
    ...
    async def test_validate_no_filename(
        self, image_validation_service, no_filename_file
    ):
...
class TestImageReading:
    ...
    async def test_read_valid_image(self, image_validation_service, valid_jpeg_file):
        ...
        content, image = await image_validation_service.read_and_validate_image(
            valid_jpeg_file
        )
    ...
    @pytest.mark.asyncio
    async def test_read_corrupted_image(
        self, image_validation_service, corrupted_image_file
    ):
    ...
    @pytest.mark.asyncio
    async def test_read_image_too_small(
        self, image_validation_service, tiny_image_file
    ):
    ...
    async def test_read_image_content_size_validation(self, image_validation_service):
        ...
        image_validation_service.max_file_size = (
            content_size - 1000
...
class TestImagePreprocessing:
    ...
    def test_preprocess_grayscale_image(
        self, image_validation_service, grayscale_image
    ):
    ...
    def test_preprocess_different_aspect_ratios(
        self, image_validation_service, wide_image, tall_image, square_image
    ):
...
class TestIntegrationScenarios:
    ...
    @pytest.mark.asyncio
    async def test_complete_validation_and_preprocessing_flow(
        self, image_validation_service, valid_jpeg_file
    ):
